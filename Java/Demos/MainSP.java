...
public class MainSP {
    ...
    public static void main(String[] args) {
		...
		String absOutputSpvFilePath = makeAbsoluteOutputFilePathWithExt(inputFilePath,outputFileFolder,"spv");
