...
//-------------------------------------
    ...
    private void parseFile(Scanner myReader){
        ...
        while (myReader.hasNextLine()){
            ...
            String weight = edgeString[2];
            //System.out.print("weight: " + weight);
            addEdge(Integer.parseInt(u), Integer.parseInt(v), Integer.parseInt(weight)); 
            line = myReader.nextLine();
        }
    }
//-------------------------------------
...
//------------------------------------- 
    ...
    for(int i = 0; i<edges.size(); i++){
        DGraphAdjList.addEdge(edges.get(i).getVertex1() -1,edges.get(i).getVertex2() -1, edges.get(i).getWeight());
    }
